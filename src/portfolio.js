...
const greeting = {
  ...
  subTitle: emoji(
    "A passionate Frontend Web Developer 🚀 having an experience of building Websites  with JavaScript / Reactjs / Nodejs and some other cool libraries and frameworks."
  ),
  resumeLink:
